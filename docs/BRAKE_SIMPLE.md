...
| Holder rights | None: no ownership, yield, redemption, or governance |

There is no team allocation, grants allocation, vesting schedule, DAO token, staking
program, burn program, or price-support promise.
...
collector wallet must automatically sweep the full amount to the published grants
wallet and appear on the transparency page.

## The grants

No DAO is needed. Token holders do not vote on grants.

People submit a short public application. RATi's board, or a board-appointed grants
committee, approves grants using three tests:

- peaceful and lawful;
- connected to public education or civic action about the AI race; and
- supported by a basic budget and receipts.
...
Use only a red octagon and a white open hand with a charcoal outline. No circuits,
brake hardware, inner rings, gradients, financial symbols, or partner logos.

Selected assets:

- `assets/brake-emblem-simple.svg` — canonical vector
- `assets/brake-emblem-simple-flat.png` — transparent 1024-pixel export

The generated PNG at `assets/brake-emblem-simple-v2.png` is retained as concept
exploration only; it is not the canonical mark.
